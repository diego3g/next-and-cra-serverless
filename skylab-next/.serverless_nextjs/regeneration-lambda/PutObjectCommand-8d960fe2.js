...
require('./regeneration-handler-04a5b372.js');
require('stream');
require('zlib');
require('http');
...
var bucketHostname = function (options) {
    ...
    return isBucketNameOptions(options)
        ? // Construct endpoint when bucketName is a string referring to a bucket name
            getEndpointFromBucketName(index.__assign(index.__assign({}, options), { isCustomEndpoint: isCustomEndpoint }))
        : // Construct endpoint when bucketName is an ARN referring to an S3 resource like Access Point
            getEndpointFromArn(index.__assign(index.__assign({}, options), { isCustomEndpoint: isCustomEndpoint }));
};
            ...
            return index.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        if (!index.HttpRequest.isInstance(request)) return [3 /*break*/, 8];
                    ...
                    case 7:
                        ...
                        _g.label = 8;
                    case 8: return [2 /*return*/, next(index.__assign(index.__assign({}, args), { request: request }))];
                }
            });
        }); };
    };
