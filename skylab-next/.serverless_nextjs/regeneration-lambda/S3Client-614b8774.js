...
var index = require('./index-e934e076.js');
var url = require('url');
...
var regenerationHandler = require('./regeneration-handler-04a5b372.js');
require('zlib');
...
var deserializeAws_queryAssumeRoleResponse = function (output, context) {
    ...
    if (output["PackedPolicySize"] !== undefined) {
        contents.PackedPolicySize = index.strictParseInt(output["PackedPolicySize"]);
    }
...
function moveHeadersToQuery(request, options) {
    ...
    return index.__assign(index.__assign({}, request), { headers: headers,
        query: query });
}
...
var resolveAwsAuthConfig = function (input) {
    ...
    return index.__assign(index.__assign({}, input), { systemClockOffset: systemClockOffset,
...
var resolveEndpointsConfig = function (input) {
    var _a;
    return (index.__assign(index.__assign({}, input), { tls: (_a = input.tls) !== null && _a !== void 0 ? _a : true, endpoint: input.endpoint ? normalizeEndpoint(input) : function () { return getEndPointFromRegion(input); }, isCustomEndpoint: input.endpoint ? true : false }));
};
...
var defaultRegionInfoProvider$2 = function (region, options) {
    ...
    return Promise.resolve(index.__assign({ signingService: "awsssoportal" }, regionInfo));
};
...
var getRuntimeConfig$5 = function (config) {
    ...
    return ({
        ...
        regionInfoProvider: (_c = config.regionInfoProvider) !== null && _c !== void 0 ? _c : defaultRegionInfoProvider$2,
...
var getRuntimeConfig$4 = function (config) {
    ...
    return index.__assign(index.__assign(index.__assign({}, clientSharedValues), config), { runtime: "node", base64Decoder: (_a = config.base64Decoder) !== null && _a !== void 0 ? _a : fromBase64, base64Encoder: (_b = config.base64Encoder) !== null && _b !== void 0 ? _b : toBase64, bodyLengthChecker: (_c = config.bodyLengthChecker) !== null && _c !== void 0 ? _c : calculateBodyLength, defaultUserAgentProvider: (_d = config.defaultUserAgentProvider) !== null && _d !== void 0 ? _d : defaultUserAgent({ serviceId: clientSharedValues.serviceId, clientVersion: packageInfo.version }), maxAttempts: (_e = config.maxAttempts) !== null && _e !== void 0 ? _e : loadConfig(NODE_MAX_ATTEMPT_CONFIG_OPTIONS), region: (_f = config.region) !== null && _f !== void 0 ? _f : loadConfig(NODE_REGION_CONFIG_OPTIONS, NODE_REGION_CONFIG_FILE_OPTIONS), requestHandler: (_g = config.requestHandler) !== null && _g !== void 0 ? _g : new NodeHttpHandler(), retryModeProvider: (_h = config.retryModeProvider) !== null && _h !== void 0 ? _h : loadConfig(NODE_RETRY_MODE_CONFIG_OPTIONS), sha256: (_j = config.sha256) !== null && _j !== void 0 ? _j : Hash.bind(null, "sha256"), streamCollector: (_k = config.streamCollector) !== null && _k !== void 0 ? _k : streamCollector, utf8Decoder: (_l = config.utf8Decoder) !== null && _l !== void 0 ? _l : fromUtf8, utf8Encoder: (_m = config.utf8Encoder) !== null && _m !== void 0 ? _m : toUtf8 });
};
...
var deserializeAws_restJson1RoleCredentials = function (output, context) {
    return {
        ...
        expiration: index.expectInt(output.expiration),
...
var resolveTokenFile = function (init) {
    ...
    return fromWebToken(index.__assign(index.__assign({}, init), { webIdentityToken: fs.readFileSync(webIdentityTokenFile, { encoding: "ascii" }), roleArn: roleArn,
...
var defaultRegionInfoProvider$1 = function (region, options) {
    ...
    return Promise.resolve(index.__assign({ signingService: "sts" }, regionInfo));
};
...
var getRuntimeConfig$2 = function (config) {
    ...
    return index.__assign(index.__assign(index.__assign({}, clientSharedValues), config), { runtime: "node", base64Decoder: (_a = config.base64Decoder) !== null && _a !== void 0 ? _a : fromBase64, base64Encoder: (_b = config.base64Encoder) !== null && _b !== void 0 ? _b : toBase64, bodyLengthChecker: (_c = config.bodyLengthChecker) !== null && _c !== void 0 ? _c : calculateBodyLength, credentialDefaultProvider: (_d = config.credentialDefaultProvider) !== null && _d !== void 0 ? _d : decorateDefaultCredentialProvider$1(defaultProvider), defaultUserAgentProvider: (_e = config.defaultUserAgentProvider) !== null && _e !== void 0 ? _e : defaultUserAgent({ serviceId: clientSharedValues.serviceId, clientVersion: packageInfo$1.version }), maxAttempts: (_f = config.maxAttempts) !== null && _f !== void 0 ? _f : loadConfig(NODE_MAX_ATTEMPT_CONFIG_OPTIONS), region: (_g = config.region) !== null && _g !== void 0 ? _g : loadConfig(NODE_REGION_CONFIG_OPTIONS, NODE_REGION_CONFIG_FILE_OPTIONS), requestHandler: (_h = config.requestHandler) !== null && _h !== void 0 ? _h : new NodeHttpHandler(), retryModeProvider: (_j = config.retryModeProvider) !== null && _j !== void 0 ? _j : loadConfig(NODE_RETRY_MODE_CONFIG_OPTIONS), sha256: (_k = config.sha256) !== null && _k !== void 0 ? _k : Hash.bind(null, "sha256"), streamCollector: (_l = config.streamCollector) !== null && _l !== void 0 ? _l : streamCollector, utf8Decoder: (_m = config.utf8Decoder) !== null && _m !== void 0 ? _m : fromUtf8, utf8Encoder: (_o = config.utf8Encoder) !== null && _o !== void 0 ? _o : toUtf8 });
};
...
function resolveBucketEndpointConfig(input) {
    ...
    return index.__assign(index.__assign({}, input), { bucketEndpoint: bucketEndpoint,
...
const getRuntimeConfig$1 = (config = {}) => {
    ...
    return ({
        ...
        urlParser: (_f = config.urlParser) !== null && _f !== void 0 ? _f : parseUrl,
...
const getRuntimeConfig = (config = {}) => {
    ...
    return {
        ...
        ...config,
        runtime: "node",
        base64Decoder: (_a = config.base64Decoder) !== null && _a !== void 0 ? _a : fromBase64,
        base64Encoder: (_b = config.base64Encoder) !== null && _b !== void 0 ? _b : toBase64,
        bodyLengthChecker: (_c = config.bodyLengthChecker) !== null && _c !== void 0 ? _c : calculateBodyLength,
        credentialDefaultProvider: (_d = config.credentialDefaultProvider) !== null && _d !== void 0 ? _d : decorateDefaultCredentialProvider(defaultProvider),
        defaultUserAgentProvider: (_e = config.defaultUserAgentProvider) !== null && _e !== void 0 ? _e : defaultUserAgent({ serviceId: clientSharedValues.serviceId, clientVersion: packageInfo$2.version }),
        eventStreamSerdeProvider: (_f = config.eventStreamSerdeProvider) !== null && _f !== void 0 ? _f : eventStreamSerdeProvider,
        maxAttempts: (_g = config.maxAttempts) !== null && _g !== void 0 ? _g : loadConfig(NODE_MAX_ATTEMPT_CONFIG_OPTIONS),
        md5: (_h = config.md5) !== null && _h !== void 0 ? _h : Hash.bind(null, "md5"),
        region: (_j = config.region) !== null && _j !== void 0 ? _j : loadConfig(NODE_REGION_CONFIG_OPTIONS, NODE_REGION_CONFIG_FILE_OPTIONS),
        requestHandler: (_k = config.requestHandler) !== null && _k !== void 0 ? _k : new NodeHttpHandler(),
        retryModeProvider: (_l = config.retryModeProvider) !== null && _l !== void 0 ? _l : loadConfig(NODE_RETRY_MODE_CONFIG_OPTIONS),
        sha256: (_m = config.sha256) !== null && _m !== void 0 ? _m : Hash.bind(null, "sha256"),
        streamCollector: (_o = config.streamCollector) !== null && _o !== void 0 ? _o : streamCollector,
        streamHasher: (_p = config.streamHasher) !== null && _p !== void 0 ? _p : fileStreamHasher,
        useArnRegion: (_q = config.useArnRegion) !== null && _q !== void 0 ? _q : loadConfig(NODE_USE_ARN_REGION_CONFIG_OPTIONS),
        utf8Decoder: (_r = config.utf8Decoder) !== null && _r !== void 0 ? _r : fromUtf8,
        utf8Encoder: (_s = config.utf8Encoder) !== null && _s !== void 0 ? _s : toUtf8,
    };
};
